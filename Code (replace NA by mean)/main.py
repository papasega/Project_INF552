...
"""
This program implements logistic regression method,
then produce the resulting csv files.
"""
...
"""
# Useless code.
alpha = 0.5 # Using alpha of train_0 and train_1 to train, 1-alpha to test
...
#print("Cross-validation Gini:") # Useless code
#print(gini(test_target,prediction)) # Useless code

# Print csv
cot1 = pd.Series(test_id)
cot2 = pd.Series(prediction)
df = pd.DataFrame(data={'id':cot1,'target':cot2})
df.to_csv("../Data/Logistics_C100_V12_K2_NoRandom.csv",index=False)
